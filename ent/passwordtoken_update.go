...
import (
	...
	"github.com/vovanwin/api-my-site/ent/predicate"
...
func (ptu *PasswordTokenUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, PasswordTokenMutation](ctx, ptu.sqlSave, ptu.mutation, ptu.hooks)
}
...
func (ptuo *PasswordTokenUpdateOne) Save(ctx context.Context) (*PasswordToken, error) {
	return withHooks[*PasswordToken, PasswordTokenMutation](ctx, ptuo.sqlSave, ptuo.mutation, ptuo.hooks)
}
